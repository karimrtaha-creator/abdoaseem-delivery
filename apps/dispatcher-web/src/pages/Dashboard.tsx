...
function csvEscape(value: string | number | boolean | null): string {
  ...
  // applied to actual strings - delay_minutes and similar numeric fields
  // are machine-computed and can legitimately be negative (an early
  // delivery), so prefixing "-5" here would wrongly turn a real number
  // into text and break sorting/summing that column in Excel.
